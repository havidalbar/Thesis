...
def load_model_pickle():
    pickle_filename: str = 'main_algorithm/resources/vector_space_model_surah_pendek.pickle'
    result_data_file = open(pickle_filename, 'rb')
    result_model = pickle.load(result_data_file)
    result_data_file.close()
                
    pickle_filename_cluster = 'main_algorithm/resources/clusterSurahPendek.pickle'

...
class VectorSpaceModel:
    def __init__(self, n_ayat, pickle_filename: str = 'resources/vector_space_model_surah_albaqarah_tanpa_filter.pickle'):
        self.documents = []
        self.features = []
        self.tf = [[]]
        self.idf = []
    ...
    def extract_documents(self, n_ayat):
        ...
        alquran_path: str = 'resources/surahAlBaqarah.xlsx'

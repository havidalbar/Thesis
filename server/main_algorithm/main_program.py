...
if __name__ == '__main__':
    ...
    print()
    pickle_filename_cluster = 'resources/clusterSurahAlBaqarahTanpaFilter.pickle'
    ...
    json.dump(results, open(f"resources/results-{class_count}-AlBaqarahTanpaFilter.json", "w"))
